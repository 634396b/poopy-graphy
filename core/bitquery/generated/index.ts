...
export const ExampleOfTimeQuery = gql`
  ...
  ethereum {
    ...
    `;
export const LatestPancakeswapPairsv1 = gql`
    query LatestPancakeswapPairsv1 {
  ethereum(network: bsc) {
    arguments(
...
export const Asd = gql`
  ...
  ethereum {
    ...
    `;
export const Sd = gql`
    query Sd($network: EthereumNetwork!, $address: String!, $inboundDepth: Int!, $outboundDepth: Int!, $limit: Int!, $currency: String!, $from: ISO8601DateTime, $till: ISO8601DateTime) {
  ethereum(network: $network) {
    inbound: coinpath(
      initialAddress: {is: $address}
      currency: {is: $currency}
...
export type LatestPancakeswapPairsv1QueryVariables = Exact<{ [key: string]: never; }>;


export type LatestPancakeswapPairsv1Query = (
  { __typename?: 'Query' }
  & { ethereum?: Maybe<(
    { __typename?: 'Ethereum' }
    & { arguments?: Maybe<Array<(
...
export type SdQueryVariables = Exact<{
  network: EthereumNetwork;
  address: Scalars['String'];
  inboundDepth: Scalars['Int'];
  outboundDepth: Scalars['Int'];
